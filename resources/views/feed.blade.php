@forelse($ads as $ad)
    <article class="post">
        <header class="post-header">
            <div class="info">
                <img src="/img/groups/{!! str_replace('-', '', $ad->owner_id) !!}.webp" title="Группа" alt="Группа">
                <div class="time-info">
            ...
            <div class="info-more">
                @if($ad->owner_id == 1)
                    <img class="info-more-our" src="/img/shield.svg" title="Создано на нашем сайте" alt="Создано на нашем сайте">
                @else
