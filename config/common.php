...
return [
    ...
    'rate_patterns'   => [
        ...
        "dollar"      => '/\D{2}([89]|[1][0-5])(\d$|\d\D{2,3}|\d([\.\,]\d?)\d$|\d{1,2}([\.\,]\d*)\D{2})|[189][0-9][0-9]?([\.\,]\d{0,2})?-[189][0-9][0-9]?([\.\,]\d{0,2})?/',
        // пока евро одинаковый с долларом
        "euro"        => '/\D{2}([89]|[1][0-5])(\d$|\d\D{2,3}|\d([\.\,]\d?)\d$|\d{1,2}([\.\,]\d*)\D{2})|[189][0-9][0-9]?([\.\,]\d{0,2})?-[189][0-9][0-9]?([\.\,]\d{0,2})?/', 
